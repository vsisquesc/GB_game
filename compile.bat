...
lcc  -debug  -v      -c -o obj\bbox.o src\libs\bbox.c
lcc  -debug  -v      -o obj\main.gb obj\main.o obj\bg_map.o obj\bg_tiles.o obj\bird_tiles.o obj\utils.o obj\audio.o obj\playable_agent.o obj\gate_tiles.o obj\obstacle_agent.o  obj\bbox.o 
